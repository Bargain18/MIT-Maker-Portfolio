...
if __name__ == "__main__":
    ...
    out_csv = f"outputs/2way-single-intersection1/{experiment_time}_alpha{args.alpha}_gamma{args.gamma}_eps{args.epsilon}_decay{args.decay}_reward{args.reward}"
